(function () {
  ...
  class Tawk {
    ...
    async initalise() {
      ...
      const widget = document.getElementById('rfrd-widget3');
    ...
    createMessageContainerContent(widget) {
      ...
      if (counter == 1) {
        ...
        videotabOne.classList.add('rfrd-video-tab-pane', 'rfrd-w-tab-pane', 'rfrd-w--tab-active', 'hiw3')
      ...
      if (counter == 2) {
        ...
        videotabTwo.classList.add('rfrd-video-tab-pane', 'rfrd-w-tab-pane', 'hiw3')
      ...
      if (counter == 3) {
        ...
        videotitleOne.textContent = "User Analytics"
        videoheadingsOne.appendChild(videonameOne)
        videoheadingsOne.appendChild(videotitleOne)
        videorowOne.appendChild(videoheadingsOne)
        var videotabOne = document.createElement('div')
        ...
        videotitleTwo.textContent = "Product Analytics"
        videoheadingsTwo.appendChild(videonameTwo)
        videoheadingsTwo.appendChild(videotitleTwo)
        videorowTwo.appendChild(videoheadingsTwo)
        var videotabTwo = document.createElement('div')
        ...
        videotitleThree.textContent = "Customer Service Data"
        ...
        videotabThree.classList.add('rfrd-video-tab-pane', 'rfrd-w-tab-pane', 'hiw3')
      ...
      if (counter == 4) {
        ...
        videotabFour.classList.add('rfrd-video-tab-pane', 'rfrd-w-tab-pane', 'hiw3')
      ...
      if (counter == 5) {
        ...
        videotabFive.classList.add('rfrd-video-tab-pane', 'rfrd-w-tab-pane', 'hiw3')
    ...
    toggleClose() {
      ...
      var videos = document.querySelectorAll(".hiw3");
