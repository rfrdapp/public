new class t{constructor(){this.initalise()}async initalise(){async function t(t){let e=await fetch("https://app.rfrd.io/read/mq/"+t).then(t=>t.json());return e}let e=document.getElementsByClassName("embed-mq-class");console.log("vid:",e),console.log("vid.length:",e.length);for(let i=0;i<e.length;i++){console.log('vid[index].getAttribute("data-id"):',e[i].getAttribute("data-id"));var a=await t(e[i].getAttribute("data-id"));console.log("magicq:",a);var s=e[i];let r=document.createElement("section");r.classList.add("rfrdmq-testimonial"),this.testimonialblock=r;let d=document.createElement("div");d.classList.add("rfrdmq-testimonial__container","rfrdmq-w-container"),this.testimonialcontainer=d;let o=document.createElement("blockquote");o.classList.add("rfrdmq-blockquote","rfrdmq-testimonial__container__block-quote-copy"),o.textContent=a.userquote,this.blockquote=o,this.blockquote.style.backgroundColor="#"+a.maincolor,this.blockquote.style.color="#"+a.secondarycolor;let n=document.createElement("div");n.classList.add("rfrdmq-testimonial__container__details"),this.testimonialcontainerdetails=n,this.testimonialcontainerdetails.style.backgroundColor="#"+a.maincolor;let l=document.createElement("div");l.classList.add("rfrdmq-testimonial-video-thumb","rfrdmq-w-background-video","rfrdmq-w-background-video-atom","rfrdmq-testimonial__details__avatar"),l.setAttribute("data-video-urls",a.video.link),l.setAttribute("data-autoplay","true"),l.setAttribute("data-loop","true"),l.setAttribute("data-wf-ignore","true"),l.style.width="70",l.style.height="70",this.testimonialvideothumbnew=l,this.testimonialvideothumbnew.addEventListener("click",this.showVid.bind(this),!1),this.testimonialvideothumbnew.setAttribute("data-id",a.video.videoid._id);let m=document.createElement("video");m.style.width="70",m.style.height="70",m.style="background-image:url('"+a.video.screengrab+"')",m.autoplay=!0,m.loop=!0,m.muted=!0,m.playsinline=!0,this.videogifynew=m,this.videogifynew.innerHTML='<source src="'+a.video.link+'" data-wf-ignore="true">',this.testimonialvideothumbnew.appendChild(this.videogifynew);let c=document.createElement("div");c.classList.add("rfrdmq-testimonial__details__meta"),this.testimonialdetailsmeta=c,this.testimonialdetailsmeta.style.color="#"+a.secondarycolor;let p=document.createElement("div");p.classList.add("rfrdmq-testimonial__details__meta__name"),p.textContent=a.username,this.testimonialdetailsname=p;let f=document.createElement("div");f.classList.add("rfrdmq-testimonial__details__meta__function"),f.textContent=a.usertitle+", "+a.usercompany,this.testimonialdetailsjob=f,this.testimonialdetailsmeta.appendChild(this.testimonialdetailsname),this.testimonialdetailsmeta.appendChild(this.testimonialdetailsjob),this.testimonialcontainerdetails.appendChild(this.testimonialvideothumbnew),this.testimonialcontainerdetails.appendChild(this.testimonialdetailsmeta),this.testimonialcontainer.appendChild(this.blockquote),this.testimonialcontainer.appendChild(this.testimonialcontainerdetails),this.testimonialblock.appendChild(this.testimonialcontainer),s.appendChild(this.testimonialblock),this.messageContainer=document.createElement("div"),this.messageContainer.classList.add("rfrdmq-hidden","rfrdmq-activated");let h=document.createElement("div");h.classList.add("rfrdmq-page-bg"),this.pagebg=h,this.pagebg.addEventListener("click",this.toggleClose.bind(this));let b=document.createElement("div");this.divinsidepagebg=b,this.pagebg.appendChild(this.divinsidepagebg),this.messageContainer.appendChild(this.pagebg);let g=document.createElement("div");g.classList.add("rfrdmq-cheer-wrap"),g.id="cheer-wrap",this.cheerwrap=g;let u=document.createElement("div");u.classList.add("rfrdmq-side-cheer-header"),this.cheerheader=u;let $=document.createElement("div");$.classList.add("rfrdmq-w-tabs"),this.videotabs=$;let v=document.createElement("div");v.classList.add("rfrdmq-w-tab-menu"),this.videotabsmenu=v;let x=document.createElement("div");x.classList.add("rfrdmq-tabs-content","rfrdmq-w-tab-content"),this.tabscontent=x;let y=document.createElement("div");y.classList.add("rfrdmq-videos-top"),this.videosTop=y;var w=document.createElement("div");w.classList.add("rfrdmq-video-tab-pane","rfrdmq-w-tab-pane","rfrdmq-w--tab-active"),this.videotabOne=w,this.videotabOne.setAttribute("data-id",a.video.videoid._id);var _=document.createElement("div");_.classList.add("rfrdmq-video-flyout-wrap"),this.videoflyoutOne=_;var q=document.createElement("div");q.classList.add("rfrdmq-video-play","rfrdmq-w-video"),q.style.marginTop="20%",this.videoembedOne=q;let k=document.createElement("video");k.classList.add("rfrdmq-mainvid"),this.mainvideo1=k,this.mainvideo1.setAttribute("data-id",a.video.videoid._id),this.mainvideo1.style="background-image:url('"+a.video.link+"')",this.mainvideo1.innerHTML='<source src="'+a.video.link+'" data-wf-ignore="true">',this.videoembedOne.appendChild(this.mainvideo1),this.videoflyoutOne.appendChild(this.videoembedOne),this.videotabOne.appendChild(this.videoflyoutOne);let C=document.createElement("div");C.classList.add("rfrdmq-video-icons"),this.videoicons1=C;let E=document.createElement("div");E.classList.add("rfrdmqsoundcontainer"),this.soundcontainer1=E;let L=document.createElement("div");L.classList.add("rfrdmq-sound-on"),this.soundon1=L,this.soundon1.addEventListener("click",this.toggleSoundOn.bind(this));let A=document.createElement("img");A.classList.add("rfrdmq-video-icon"),this.soundonimg1=A,this.soundonimg1.src="https://assets.website-files.com/5e62b74e92e93371af2386aa/61f471968311785ca000deb4_sound%20on.svg";let j=document.createElement("div");j.classList.add("rfrdmq-sound-off"),this.soundoff1=j,this.soundoff1.style.display="none",this.soundoff1.addEventListener("click",this.toggleSoundOff.bind(this));let S=document.createElement("img");S.classList.add("rfrdmq-video-icon"),this.soundoffimg1=S,this.soundoffimg1.src="https://assets.website-files.com/5e62b74e92e93371af2386aa/61f4718b5bc38a8ec998e79d_sound%20off.svg",this.soundon1.appendChild(this.soundonimg1),this.soundoff1.appendChild(this.soundoffimg1),this.soundcontainer1.appendChild(this.soundon1),this.soundcontainer1.appendChild(this.soundoff1);let O=document.createElement("div");O.classList.add("rfrdmqplaycontainer"),this.playcontainer1=O;let z=document.createElement("div");z.classList.add("rfrdmq-pause-video-block"),this.pause1=z;let T=document.createElement("img");T.classList.add("rfrdmq-video-icon"),this.pauseimg1=T,this.pauseimg1.style.display="none",this.pauseimg1.src="https://assets.website-files.com/5e62b74e92e93371af2386aa/61f46e4fa465082830b2901a_pauseicon.svg",this.pauseimg1.addEventListener("click",this.pauseVid.bind(this));let V=document.createElement("div");V.classList.add("rfrdmq-play-video-block"),this.play1=V;let F=document.createElement("img");F.classList.add("rfrdmq-video-icon"),this.playimg1=F,this.playimg1.src="https://assets.website-files.com/5e62b74e92e93371af2386aa/61f46ec2a8ae0801811c4c3e_playico.svg",this.playimg1.addEventListener("click",this.playVid.bind(this)),this.pause1.appendChild(this.pauseimg1),this.play1.appendChild(this.playimg1),this.playcontainer1.appendChild(this.pause1),this.playcontainer1.appendChild(this.play1);let B=document.createElement("div");this.fullscreencontainer1=B;let H=document.createElement("img");H.classList.add("rfrdmq-video-icon"),this.fullscreenimg1=H,this.fullscreenimg1.src="https://assets.website-files.com/5e62b74e92e93371af2386aa/61f46e4f6a5ac52cc0393bce_expand.svg",this.fullscreenimg1.addEventListener("click",this.toggleFullScreen.bind(this)),this.fullscreencontainer1.appendChild(this.fullscreenimg1),this.videoicons1.appendChild(this.soundcontainer1),this.videoicons1.appendChild(this.playcontainer1),this.videoicons1.appendChild(this.fullscreencontainer1),this.videoembedOne.appendChild(this.videoicons1),this.tabscontent.appendChild(this.videotabOne),this.messageContainer.appendChild(this.tabscontent);let M=document.createElement("div");M.classList.add("rfrdmq-overlay-wrapper"),this.modalbackground=M,this.modalbackground.style="transform-style: preserve-3d; display: none; transition: transform 240ms ease 0s, opacity 240ms ease 0s; opacity: 0; transform: scaleX(1.05) scaleY(1.05) scaleZ(1);",this.modalbackground.setAttribute("data-id",a.video.videoid._id),this.modalbackground.appendChild(this.messageContainer),document.body.appendChild(this.modalbackground)}this.createStyles(a)}createStyles(t){let e=document.createElement("style");e.innerHTML=`
